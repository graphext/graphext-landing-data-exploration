          ...
          >
            ...
            >
              <motion.path
                ...
                animate={{ fill: isScrolled ? "#1D1D1D" : "#ffffff" }}
                ...
                >
                  ...
                  <a
                    ...
                    style={{
                      ...
                      boxShadow:
                        "0 4px 15px rgba(59, 130, 246, 0.35), inset 0 1px 0 rgba(255, 255, 255, 0.3)",
                    }}
                    onClick={() => setIsMobileMenuOpen(false)}
                  >
                    <span
                      ...
                      style={{
                        background:
                          "linear-gradient(180deg, rgba(255,255,255,0.25) 0%, rgba(255,255,255,0.1) 50%, transparent 50%, transparent 100%)",
                      }}
                    />
                    <span className="relative">SIGN UP</span>
                  </a>
